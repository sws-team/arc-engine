...
void GameManagers::loadTranslations()
{
	...
	germanTranslation.insert(TR_PAIR(GAME_TRANSLATION::ALL_HOTKEYS_TEXT, L"Space - starten / überspringen\n"
																		 "Enter - Aktion / Weiter\n"
																		 "Escape - Pause / zurück\n"
																		 "BackSpace - Kamera zurücksetzen\n"
																		 "Tab - Säure drehen\n"
																		 "Q - Panel\n"
																		 "F - Aktualisierung\n"
																		 "+ , wheel up - hineinzoomen\n"
																		 "-, wheel down - Rauszoomen\n"
																		 "Left - Bewegen Sie den Cursor nach links\n"
																		 "Right - Bewegen Sie den Cursor nach rechts\n"
																		 "Up - Bewegen Sie den Cursor nach oben\n"
																		 "Down - Bewegen Sie den Cursor nach unten\n"
																		 "T - Gewöhnlicher Turm\n"
																		 "Y - Gefrierturm\n"
																		 "U - Raketenturm\n"
																		 "G - Energieturm\n"
																		 ...
																		 "X - Frostbombe\n"
																		 "C - Säure\n"
																		 "V - Verursachter Schaden steigt\n"
																		 "B - Erhöhen Sie die Feuerrate\n"
																		 "N - Stasis\n"
																		 "R, Delete - verkaufen\n"
																		 "F3 - anzeigen FPS"));
	...
	brazilianTranslation.insert(TR_PAIR(GAME_TRANSLATION::ALL_HOTKEYS_TEXT, L"Space - iniciar / pular\n"
																			"Enter - ação / próxima\n"
																			"Escape - pausa / voltar\n"
																			"BackSpace - redefinir câmera\n"
																			"Tab - rodar ácido\n"
																			"Q - painel\n"
																			"F - melhoria\n"
																			"+ , wheel up - zoom\n"
																			"-, wheel down - Reduzir o zoom\n"
																			"Left - mover o cursor para a esquerda\n"
																			"Right - mover o cursor para a direita\n"
																			"Up - mover o cursor para cima\n"
																			"Down - mover o cursor para baixo\n"
																			"T - construir Torre base\n"
																			"Y - construir Torre de congelamento\n"
																			"U - construir Torre foguete\n"
																			"G - construir  Torre de energia\n"
																			"H - construir Torre laser\n"
																			"J - construir Torre melhorada\n"
																			"Z - bomba\n"
																			"X - congelar bomba\n"
																			"C - àcido\n"
																			"V - aumento de dano infligido\n"
																			"B - aumento de velocidade de ataque\n"
																			"N - Estase\n"
																			"R, Delete - vender\n"
																			"F3 - mostrar FPS"));
